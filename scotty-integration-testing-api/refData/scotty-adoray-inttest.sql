...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`dockerdefault`@`%`*/ /*!50003 TRIGGER onInsertLiedSetCreatedAt BEFORE INSERT ON lied FOR EACH ROW set NEW.created_at = NOW() */;;
DELIMITER ;
...
/*!50013 DEFINER=`dockerdefault`@`%` SQL SECURITY DEFINER */
