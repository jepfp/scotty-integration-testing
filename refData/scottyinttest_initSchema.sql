...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`scottyinttest`@`localhost`*/ /*!50003 TRIGGER onInsertLiedSetCreatedAt BEFORE INSERT ON lied FOR EACH ROW set NEW.created_at = NOW() */;;
DELIMITER ;
...
/*!50013 DEFINER=`scottyinttest`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2015-01-09 17:32:03
